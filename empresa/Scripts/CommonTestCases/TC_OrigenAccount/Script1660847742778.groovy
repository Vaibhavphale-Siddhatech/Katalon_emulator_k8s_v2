...
if (CtaOrigen == '') {
	GlobalVariable.origen_before_app = "NotAvailable"
	GlobalVariable.OrigenAccountStatus = "NotAvailable"
    println('Origen Account Not Available...!!!')
} else {
    Mobile.tap(findTestObject('PagosYTransferencia/Origen-Title'), 5, FailureHandling.OPTIONAL)
...
//		} else {
////			CustomKeywords.'helper.customfunction.Screenshot'()
//			KeywordUtil.markPassed("Origen Balance Has Sufficient Balance...!!!")
//		}
//	}
}