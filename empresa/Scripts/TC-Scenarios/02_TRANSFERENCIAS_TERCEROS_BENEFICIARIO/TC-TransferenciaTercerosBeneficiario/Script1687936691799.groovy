...
'TRANSFERENCIA TERCEROS BENEFICIARIO : '
...
if (Mobile.waitForElementPresent(findTestObject('PagosYTransferencia/Origen-Title'), 10, FailureHandling.OPTIONAL)) {
	...
	'CHECK AND ENTER PAGO TYPE FOR CASE 3.5'
	if(Mobile.verifyElementVisible(findTestObject('Object Repository/TransferenciaLBTRPagoUnico/Mtodo de pago - Title'), 2, FailureHandling.OPTIONAL)) {
