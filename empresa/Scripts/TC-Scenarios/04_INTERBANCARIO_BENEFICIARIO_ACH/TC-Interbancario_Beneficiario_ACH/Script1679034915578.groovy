...
'INTERBANCARIO BENEFICIARIO ACH : '
...
if (Mobile.waitForElementPresent(findTestObject('PagosYTransferencia/Origen-Title'), 30, FailureHandling.OPTIONAL)) {
    ...
    'ENTER METHOD FOR PAYMENT : '
    WebUI.callTestCase(findTestCase('CommonTestCases/TC_PaymentMethod'), [('Method') : Method], FailureHandling.CONTINUE_ON_FAILURE)
