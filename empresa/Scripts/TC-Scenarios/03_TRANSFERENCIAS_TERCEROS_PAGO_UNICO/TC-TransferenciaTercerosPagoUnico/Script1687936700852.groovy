...
'TRANSFERENCIA TERCEROS PAGO UNICO : '
...
if (Mobile.waitForElementPresent(findTestObject('PagosYTransferencia/Origen-Title'), 10, FailureHandling.OPTIONAL)) {
	...
	WebUI.callTestCase(findTestCase('CommonTestCases/TC_DestinoAccountPagoUnico'), [('CtaDestino') : CtaDestino, ('Banco') : Banco, ('Moneda') : Moneda, ('TipoDeProducto') : TipoDeProducto, ('CuentaDestino') : CuentaDestino, ('Description') : Description], FailureHandling.CONTINUE_ON_FAILURE)
	...
	'CHECK AND ENTER PAGO TYPE FOR CASE 4.6'
	if(Mobile.verifyElementVisible(findTestObject('Object Repository/TransferenciaLBTRPagoUnico/Mtodo de pago - Title'), 5, FailureHandling.OPTIONAL)) {
		Mobile.tap(findTestObject('Object Repository/TransferenciaLBTRPagoUnico/Mtodo de pago - Title'), 5, FailureHandling.OPTIONAL)
		Mobile.delay(1)
		CustomKeywords.'helper.customfunction.PagoUnicoHelper'('ACH', 'Object Repository/TransferenciaLBTRPagoUnico/Mtodo de pago - Title')
	}
