...
'PAGO TARJETA TERCEROS PAGO UNICO : '
...
if (Mobile.waitForElementPresent(findTestObject('PagosYTransferencia/Origen-Title'), 10, FailureHandling.OPTIONAL)) {
	...
	WebUI.callTestCase(findTestCase('CommonTestCases/TC_DestinoAccountPagoUnico'), [('CtaDestino') : CtaDestino, ('Banco') : Banco, ('Moneda') : Moneda, ('TipoDeProducto') : TipoDeProducto, ('CuentaDestino') : CuentaDestino, ('Description') : Description], FailureHandling.STOP_ON_FAILURE)
